        ...
        {imageFirst ? (
          ...
          <>
            <Grid item xs={12} sm={6}>
              ...
              <Typography variant="body1">
              At Infini Health, we prioritize delivering healthcare in a state-of-the-art environment, equipped with the latest advancements in medical technology and a range of specialized facilities. 
